...
class spulsPlotter():
    ...
    def __init__(self, spulsdir, no_channel_add=False, normalize=True):
        ...
        print('no_chan_Add: ' + str(self.no_channel_add))    
        if len(fid.shape) == 1:
...
if __name__ == '__main__':
    ...
    parser.add_argument('directory', help='spuls.fid directory')
